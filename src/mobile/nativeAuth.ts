...
export const ABSOLUTE_EXPO_AUTH_CORE_VERSION = '0.76.3' as const;
export const ABSOLUTE_EXPO_AUTH_PACKAGE = '@absolutejs/auth-expo' as const;
export const ABSOLUTE_EXPO_AUTH_VERSION = '0.0.6' as const;
...
export const ABSOLUTE_EXPO_SYNC_VERSION = '0.0.4' as const;
