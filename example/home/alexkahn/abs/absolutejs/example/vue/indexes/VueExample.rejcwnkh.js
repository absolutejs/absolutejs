...
// example/vue/client/composables/useCount.js
...
// example/vue/client/components/CountButton.js
...
// example/vue/client/pages/VueExample.js
var script2 = defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { props, count, isOpen, CountButton: CountButton_default };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
...
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(Fragment, null, [
    createBaseVNode("header", null, [
      _cache[3] || (_cache[3] = createBaseVNode("a", { href: "/" }, "AbsoluteJS", -1)),
      createBaseVNode("details", {
        open: $setup.isOpen,
        onPointerenter: _cache[0] || (_cache[0] = ($event) => $setup.isOpen = true),
        onPointerleave: _cache[1] || (_cache[1] = ($event) => $setup.isOpen = false)
      }, [..._cache[2] || (_cache[2] = [
        createStaticVNode('<summary>Pages</summary><nav><a href="/html">HTML</a><a href="/react">React</a><a href="/htmx">HTMX</a><a href="/svelte">Svelte</a><a href="/vue">Vue</a><a href="/angular">Angular</a></nav>', 2)
      ])], 40, _hoisted_1)
    ]),
    createBaseVNode("main", null, [
      _cache[4] || (_cache[4] = createBaseVNode("nav", null, [
        createBaseVNode("a", {
      ...
      _cache[5] || (_cache[5] = createBaseVNode("h1", null, "AbsoluteJS + Vue", -1)),
      createVNode($setup["CountButton"], { initialCount: $setup.count }, null, 8, ["initialCount"]),
      _cache[6] || (_cache[6] = createBaseVNode("p", null, [
        createTextVNode(" Edit "),
        createBaseVNode("code", null, "example/vue/pages/VueExample.vue"),
        createTextVNode(" and save to test HMR. ")
      ], -1)),
      _cache[7] || (_cache[7] = createBaseVNode("p", { style: { "margin-top": "2rem" } }, " Explore the other pages to see how AbsoluteJS seamlessly unifies multiple frameworks on a single server. ", -1)),
      _cache[8] || (_cache[8] = createBaseVNode("p", { style: { color: "#777", "font-size": "1rem", "margin-top": "2rem" } }, " Click on the AbsoluteJS and Vue logos to learn more. ", -1))
    ])
  ], 64);
}
...
var readDomCounter = (element, properties) => {
  element.querySelectorAll('[class*="value"], [class*="count"]').forEach((stateEl) => {
    const text = stateEl.textContent;
    if (text === null || text.trim() === "")
      return;
    const num = parseInt(text.trim(), 10);
    if (!isNaN(num))
      properties["__dom_counter"] = num;
  });
};
...
var captureInstanceProperties = (ngApi, element, properties) => {
  if (!ngApi || typeof ngApi.getComponent !== "function")
    return;
  try {
...
var restoreInstanceProperties = (instance, snap) => {
  ...
  Object.entries(snap.properties).forEach(([key, value]) => {
    if (key === "__dom_counter")
      return;
    safeSetProperty(instance, key, value);
  });
  if (domCounter !== undefined && typeof domCounter === "number" && "count" in instance) {
...
var restoreDomFallback = (element, snap) => {
  ...
  if (domCounter === undefined)
    return;
  element.querySelectorAll('[class*="value"], [class*="count"]').forEach((counterEl) => {
...
var restoreComponentState = (snapshots) => {
  ...
  bySelector.forEach((snaps, selector) => {
    ...
    snaps.forEach((snap) => {
      ...
      if (!restored)
        restoreDomFallback(element, snap);
    });
  });
};
...
var runWithViewTransition = (updateFn) => {
  ...
  doc2.startViewTransition(async () => {
    await updateFn();
  }).finished.then(removeStyle).catch(removeStyle);
};
...
var createCSSLoadPromise = (linkElement, newHref) => new Promise((resolve) => {
  let resolved = false;
...
var collectScripts = (container) => Array.from(container.querySelectorAll("script[src]")).map((script3) => ({
  src: script3.getAttribute("src") || "",
  type: script3.getAttribute("type") || "text/javascript"
}));
var collectScriptsFromElement = (elem) => Array.from(elem.querySelectorAll("script[src]")).map((script3) => ({
  src: script3.getAttribute("src") || "",
  type: script3.getAttribute("type") || "text/javascript"
}));
...
var collectScripts2 = (container) => Array.from(container.querySelectorAll("script[src]")).map((script3) => ({
  src: script3.getAttribute("src") || "",
  type: script3.getAttribute("type") || "text/javascript"
}));
var collectScriptsFromElement2 = (elem) => Array.from(elem.querySelectorAll("script[src]")).map((script3) => ({
  src: script3.getAttribute("src") || "",
  type: script3.getAttribute("type") || "text/javascript"
}));
...
window.addEventListener("error", (evt) => {
  ...
  showErrorOverlay({
    ...
    kind: "runtime",
    message: evt.error instanceof Error ? evt.error.stack || evt.error.message : String(evt.error)
  });
});
window.addEventListener("unhandledrejection", (evt) => {
  ...
  showErrorOverlay({
    framework: detectCurrentFramework() || undefined,
    kind: "runtime",
    message: evt.reason instanceof Error ? evt.reason.stack || evt.reason.message : String(evt.reason)
  });
});
...
// example/vue/indexes/VueExample.js
...
var isHMR = typeof window !== "undefined" && sessionStorage.getItem("__HMR_ACTIVE__");
var app = isHMR ? createApp(VueExample_default, mergedProps) : createSSRApp(VueExample_default, mergedProps);
app.mount("#root");
if (typeof window !== "undefined") {
